...
class Workspace(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_workspaces_metadata', 'metadata_json', postgresql_using='gin', postgresql_ops={'metadata_json': 'jsonb_ops'}), # Added operator class
    )
...
class File(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_files_metadata', 'metadata_json', postgresql_using='gin', postgresql_ops={'metadata_json': 'jsonb_ops'}), # Added operator class
    )
...
class Context(Base):
    ...
    __table_args__ = (
        ...
        # Metadata queries
        Index('idx_contexts_metadata', 'metadata_json', postgresql_using='gin', postgresql_ops={'metadata_json': 'jsonb_ops'}), # Added operator class
